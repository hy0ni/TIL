...
`let date = new Date(2023, 2, 1)`<br>
이 코드의 결과는 2023년 3월 1일이다.<br>
( month는 0~11까지의 숫자가 입력되어야 하고, 0은 1월이다.)

`let lastDate = new Date(2023, 2, 0)`<br>
2023년 3월 0일이 되지만 2023년 3월 0일은 없으므로<br>
...
`let lastDateBefore = new Date(2023, 2, -1)`<br>
2023년 3월 -1일은 없으므로, <br>
2023년 3월 1일의 2일 전날인 `2023년 2월 27일`을 반환하게 된다.

Date() 함수의 day란에 0 이하의 값을 입력하여, 해당 월의 1일을 기준으로,<br> (|day|+1)의 전일자를 계산할 수 있다.
