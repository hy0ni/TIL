...
'1970년 1월1 일 00:00:00 UTC'의 getTime() 값은 0  
...
밀리 세컨드(millisecond) 단위의 경과 시간을 초 단위(second)로 변환하기 위해 1000으로 나누고,  
...
`const elapsedMSec = date2 - date1`  
Date 객체의 연산을 할 때 getTime() 메서드를 사용하지 않고,  
